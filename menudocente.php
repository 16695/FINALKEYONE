...
<html lang="es" dir="ltr">
	<head>
		<title>MenuDocente - ExtraEscolaresV2&#39;0</title>
		<meta charset="utf-8" />
		...
		<link rel="stylesheet" type="text/css" href="ExtraEscolaresV2'0/Preview/pcss/menudocente.css" media="screen" />
	...
	<body>
		...
		<div id="imPage">
			<div id="imHeader">
				<h1 class="imHidden">MenuDocente - ExtraEscolaresV2&#39;0</h1>
			...
			<div id="imContent">
				...
				<h2 align="right" id="imPgTitle"><span class="we"></span>  <MARQUEE BEHAVIOR=alternate>      BIENVENIDO DOCENTE    </MARQUEE>     </h2>
				...
				<ul id="MenuBar1" class="MenuBarHorizontal">
				  <li><a class="MenuBarItemSubmenu" href="#">CONSULTAR</a>
				    <ul>
				      <li><a href="#">numero de control</a></li>
